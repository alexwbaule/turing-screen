...
var (
	...
	VIDEO_DEVICE_PATH = "/root/video/gunpla.mp4"
	VIDEO_LOCAL_PATH  = "FromApp/5inchENG/TURZX-V3.1.0-5inchENG/video/800480/gunpla.mp4"
	DISPLAY_WIDTH     = 480
	DISPLAY_HEIGHT    = 800
)
...
func (l *LcdCommRevC) UploadFile(localPath string, destinationPath string) {
	...
	l.sendCommand(UPLOAD_FILE, pyd, nil, false, 0)
